						...
						<tr align='center'   height="22">
						    ...
						    <td width="75%" height="45"  align="left">
						     <input type="submit" name="Submit5" value="提交" onClick="return checkform();" class="btn btn-info btn-small" />
						       <input type="reset" value="重置" class="btn btn-info btn-small"/>&nbsp;<input type="hidden" name="id" value="${requestScope.yonghu.id}"/>
					      </td>
						</tr>
						<script language="javascript">document.form1.zhanghao.value='${yonghu.zhanghao}';</script>	<script language="javascript">document.form1.mima.value='${yonghu.mima}';</script>	<script language="javascript">document.form1.xingming.value='${yonghu.xingming}';</script>	<script language="javascript">document.form1.xingbie.value='${yonghu.xingbie}';</script>	<script language="javascript">document.form1.shouji.value='${yonghu.shouji}';</script>	<script language="javascript">document.form1.shenfenzheng.value='${yonghu.shenfenzheng}';</script>	<script language="javascript">document.form1.zhaopian.value='${yonghu.zhaopian}';</script>	<script language="javascript">document.form1.beizhu.value='${yonghu.beizhu}';</script>	
			  </table>
			</form>
   </body>
</html>
