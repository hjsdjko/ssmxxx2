...
while(RS_result.next()){
    ...
    <td><%=RS_result.getString("yaoxiao")%></td>
					...
					<td width="200px" height="50"  align="center"><!--lianjie1--> <input type="button" value="详细" onclick="shangpinxinxiDetail(${shangpinxinxi.id})" class="btn btn-info btn-small" /></td>
				</tr>
				<%} %>
	</table>
	</body>
