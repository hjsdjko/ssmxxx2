...
<script type="text/javascript" src="js/My97DatePicker/WdatePicker.js" charset="gb2312"></script>
	...
	<form action="" name="formAdd" method="post">
				     <table width="98%" align="center" border="1" cellpadding="4" cellspacing="1" bgcolor="#CBD8AC" style="margin-bottom:8px">
						<tr bgcolor="#E7E7E7">
							<td height="10" colspan="8" background="img/tbg.gif">所有药品入库列表</td>
						</tr>
    ...
    <td >入库说明</td>
				 ...
				 <%
			String sql="select * from t_yaopinruku where 1=1 ";
...
while(RS_result.next()){
    ...
    <td><%=RS_result.getString("rukushuoming")%></td>
					...
					<td width="200px" height="50"  align="center"><!--lianjie1--> <input type="button" value="详细" onclick="yaopinrukuDetail(${yaopinruku.id})" class="btn btn-info btn-small" /></td>
				</tr>
				<%} %>
	</table>
	</body>
