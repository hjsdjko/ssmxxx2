...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body> 
			<form action="yonghuzhuceUpdt2.action" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#CCCCCC" style="border-collapse:collapse">
						<tr bgcolor="#E7E7E7">
							<td height="20" colspan="2" >修改用户注册</td>
						</tr>
						...
						<tr align='center'   height="22">
						    ...
						    <td width="75%"  align="left">
						     <input type="submit" name="Submit5" value="提交" onClick="return checkform();"/>
						       <input type="reset" value="重置"/>&nbsp;<input type="hidden" name="id" value="${requestScope.yonghuzhuce.id}"/>
						    </td>
						</tr>
	...
	<script language="javascript">document.form1.dianhua.value='${yonghuzhuce.dianhua}';</script>
