...
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
			<form action="youqinglianjieAdd.action" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#CCCCCC" style="border-collapse:collapse">
						<tr bgcolor="#E7E7E7">
							<td height="20" colspan="2" >添加友情连接<input name="addtime" type="hidden" id="addtime" value="<%=connDbBean.gettime()%>" /></td>
						</tr>
						<tr ><td width="200">网站名称：</td><td><input name='wangzhanmingcheng' type='text' id='wangzhanmingcheng' value='' onblur='checkform()' class="form-control" />&nbsp;*<label id='clabelwangzhanmingcheng' style='margin-top:16px;' /></td></tr>		<tr ><td width="200">网址：</td><td><input name='wangzhi' type='text' id='wangzhi' value='' onblur='checkform()' class="form-control" />&nbsp;*<label id='clabelwangzhi' style='margin-top:16px;' /></td></tr>		<tr ><td width="200">logo：</td><td><input name='logo' type='text' id='logo'  value='' onblur='' class="form-control" /><div style="margin-top:16px;">&nbsp;<input type='button' value='上传' onClick="up('logo')" /></div></td></tr>		
